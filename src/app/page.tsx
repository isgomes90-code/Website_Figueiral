...
const highlights = [
  "Fire-led cooking with Mediterranean restraint",
  "Portuguese wine chosen for long conversations",
  "An Almancil address trusted since 1986",
  "Family hospitality with international ease"
];
          ...
          <div className="mx-auto mt-14 grid max-w-6xl gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {highlights.map((item, index) => (
              <MotionReveal
                key={item}
                delay={index * 0.07}
                className={`luxury-card rounded-[1.55rem] p-6 sm:p-7 ${index % 2 === 1 ? "lg:mt-8" : ""}`}
              >
