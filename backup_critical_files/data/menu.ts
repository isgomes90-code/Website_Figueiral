...
export const menuHeroImage = "/images/food/Picanha-grelha-2.webp";

/** Bloco editorial «À mesa» (posição 2 na página). */
export const menuAtTableImage = "/images/people/mesa-convivio-opt.webp";

/** Order matches menu.categories: Para Começar → Carne → Algarve → Sobremesas */
export const categoryVisuals = [
  {
    image: "/images/food/camarao-com-alho-entrada-opt.webp",
    mini: "/images/food/Camarao-grelhado-Entrada-opt.webp",
    overlay: "linear-gradient(180deg, rgba(92,68,48,0.04), rgba(92,68,48,0.32))"
  },
  {
    image: "/images/hero/Preparacao-picanha.webp",
    mini: "/images/food/Chateaubriand-opt.webp",
  ...
  {
    image: "/images/food/Profiteroles-chocolate-opt.webp",
    mini: "/images/food/Tarte-maca-opt.webp",
